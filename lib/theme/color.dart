...
=======
const mainColor = Color(0xFF262626);
const darker = Color(0xFF1C1E21);
const appBgColor = Color(0xFF353E3B);
const appBarColor = import 'package:flutter/material.dart';
...
Colors.white70;
const bottomBarColor = Colors.white70;
const inActiveColor = Colors.white70;
const shadowColor = Colors.black;
const textBoxColor = Colors.black;
const textColor = Color(0xAB2F2C2C);
const labelColor = Color(0xFFF8F8F8);
>>>>>>> master
